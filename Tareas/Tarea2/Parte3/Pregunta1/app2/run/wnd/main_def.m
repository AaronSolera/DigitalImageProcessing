...
% Metodo de retaurancion que usa K en A
...
function ret = show_main()
  ...
  _xPos = (_scrSize(3) - 1581)/2;
  _yPos = (_scrSize(4) - 574)/2;
   main = figure ( ... 
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 1581 574], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
