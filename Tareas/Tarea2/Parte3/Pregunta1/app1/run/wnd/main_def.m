...
function ret = show_main()
  ...
  _xPos = (_scrSize(3) - 1097)/2;
  _yPos = (_scrSize(4) - 498)/2;
   main = figure ( ... 
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 1097 498], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
