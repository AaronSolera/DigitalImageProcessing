...
function ret = show_main()
  ...
  _xPos = (_scrSize(3) - 1116)/2;
  _yPos = (_scrSize(4) - 549)/2;
   main = figure ( ... 
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 1116 549], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
